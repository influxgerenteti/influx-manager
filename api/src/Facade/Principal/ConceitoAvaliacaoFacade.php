 ...
 */
class ConceitoAvaliacaoFacade extends GenericFacade
{
    ...
    {
        $retornoRepositorio = $this->conceitoAvaliacaoRepository->filtrarPorPagina($parametros, $parametros[ConstanteParametros::CHAVE_PAGINA]);
        $retorno            = [
