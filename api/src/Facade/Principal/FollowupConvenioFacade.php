...
use App\BO\Principal\FollowupConvenioBO;

/**
 *
 * @author Luiz A Costa
 */
class FollowupConvenioFacade extends GenericFacade
{

    /**
     *
     * @var \App\BO\Principal\FollowupConvenioBO
     */
    private $followupConvenioBO;
    ...
    function __construct (ManagerRegistry $managerRegistry, $connection="base_principal")
    {
        ...
        $this->followupConvenioBO = new FollowupConvenioBO(self::getEntityManager());
    }
    ...
    public function criar(&$mensagemErro, $parametros=[])
    {
        ...
        $followUp            = $parametros[ConstanteParametros::CHAVE_FOLLOW_UP];
        $followUpHeader      = "";
        $nomeTipoContato     = null;
        $objetoORM           = null;

        if ($this->followupConvenioBO->podeCriar($parametros, $mensagemErro) === true) {
            ...
            if (is_null($nomeTipoContato) === false) {
                $followUpHeader = $followUpHeader . " - Tipo de Contato: " . $nomeTipoContato . " \n";
            } else {
                $followUpHeader = $followUpHeader . " \n";
            }
            ...
            $objetoORM = \App\Factory\GeneralORMFactory::criar(\App\Entity\Principal\FollowupConvenio::class, true, $parametros);
