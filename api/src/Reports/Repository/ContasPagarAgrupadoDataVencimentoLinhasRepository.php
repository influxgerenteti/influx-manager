...
class ContasPagarAgrupadoDataVencimentoLinhasRepository
{
    ...
    public function get($where, $dataProrrogacao)
    {
        $sql = <<<SQL
            select
            ...
            where $where
            and (tituloPagar.data_prorrogacao >= "$dataProrrogacao" AND tituloPagar.data_prorrogacao <= "$dataProrrogacao 23:59:59")
        SQL;
